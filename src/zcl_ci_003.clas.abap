class ZCL_CI_003 definition
  public
  inheriting from CL_CI_TEST_SCAN
  create public .

*"* public components of class ZCL_CI_003
...
public section.
  ...
  methods RUN
    redefinition .
protected section.
*"* protected components of class ZCL_CI_003
*"* do not include other source files here!!!
...
private section.
*"* private components of class ZCL_CI_003
*"* do not include other source files here!!!

  constants C_MY_NAME type SEOCLSNAME value 'ZCL_CI_003'. "#EC NOTEXT
  constants MCODE_0001 type SCI_ERRC value '0001' ##NEEDED.
ENDCLASS.



CLASS ZCL_CI_003 IMPLEMENTATION.


method CONSTRUCTOR .
  SUPER->CONSTRUCTOR( ).
  DESCRIPTION        = '3.- Uso de Authority-check'(000).
  VERSION            = '001'.
